...
```markdown
## **P_6996cc3c. Deduction via Necessary Condition Elimination**
...
```markdown
## **P_cca592d7. Proportional Reasoning with Variable Substitution**
...
```markdown
## **P_e01bd003. Proportionality and Scaling with Square Roots**
...
```markdown
## **P_015d0245. Elimination by Contradiction with Cases**
