# ESAT Physics Generation Pipeline V4

## Purpose

## V4 update summary

V4 adds a second major improvement on top of V3:
...
This pack upgrades the Physics generation pipeline in two directions at once:
...
> ESAT / ENGAA / NSAA-style Physics difficulty should come from a compact reasoning hinge, not from more words, more arithmetic, or more obscure content.
...
- transport/mechanics setup illustrations,
- thermal visualisations,
- floating-object scenes,
- simple apparatus illustrations,
- solution explanation visuals,
- non-scale shape/apparatus views,
- anything where the visual should look convincing and professional but must remain illustrative.
