...
export const HOMEPAGE_EXAMPLE_QUESTION = {
  ...
  promptMarkdown: [
    "A person of fixed height moves away from a stationary camera with fixed zoom.",
    "",
    "Which curve could show their image height $H$ against distance $d$ from the camera?",
  ].join("\n"),
  options: [
