...
export const ESAT_CAMP_MOCK_ROADMAP_STAGES: RoadmapStage[] = [
  {
    ...
    parts: [
      {
        partKey: 'mock-1-mathematics',
        displayGroupKey: 'mock-1',
        displayName: ESAT_CAMP_MOCK_DISPLAY_NAMES.mock1,
        partLetter: 'Part A',
      ...
      {
        partKey: 'mock-2-physics',
        displayGroupKey: 'mock-2',
        displayName: ESAT_CAMP_MOCK_DISPLAY_NAMES.mock2,
        partLetter: 'Part A',
        partName: 'Physics',
