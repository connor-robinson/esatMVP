  ...
  addition: {
    ...
    variants: [
      ...
      },
      {
        ...
        name: "Carry Only",
        description: "2 digits + 2 digits; every question needs a ones carry",
        difficulty: 3,
        config: { digits: 2, allowCarry: true, carryOnly: true },
      },
      {
        id: "mental-add-5",
        name: "Add 5 / 10 / 15 / 20",
      ...
      },
      {
        ...
        description: "Three addends: single digits or numbers under 20",
        difficulty: 5,
        config: { count: 3, maxOperand: 19 },
      },
      {
