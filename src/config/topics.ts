...
export const TOPICS: Record<string, Topic> = {
  ...
  systemsOfEquations: {
    ...
    variants: [
      ...
      {
        id: "three-equations",
        name: "Three Equations (Easy)",
        description: "Three simultaneous equations in x, y, z (small integers)",
        difficulty: 4,
        config: { level: 4 },
      },
      {
        id: "three-equations-hard",
        name: "Three Equations (Hard)",
        description: "Harder 3×3 simultaneous equations (bigger coefficients)",
        difficulty: 6,
        config: { level: 5 },
      },
    ],
