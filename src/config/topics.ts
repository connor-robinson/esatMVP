  ...
  geometry_3d: {
    ...
    variants: [
      ...
      },
      {
        id: "volume-prisms",
        name: "Prism Volume",
        description: "Cuboid and cylinder volume",
        difficulty: 1,
        config: { level: 11 },
      },
      {
        id: "volume-cone-pyramid",
        name: "Cone & Pyramid Volume",
        description: "Cone and square-based pyramid volume",
        difficulty: 2,
        config: { level: 15 },
      },
      {
        id: "volume-cone",
        name: "Cone Volume",
        description: "Volume of a cone in terms of π",
        difficulty: 2,
        config: { level: 12 },
      },
      {
      ...
      },
      {
        id: "volume-spheres",
        name: "Sphere Volume",
        description: "Sphere and hemisphere volume in terms of π",
        difficulty: 2,
        config: { level: 14 },
      },
      {
