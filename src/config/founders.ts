...
export const FOUNDERS = {
  ewan: {
    ...
    imageAlt:
      "Temporary portrait placeholder for Ewan Ellson, co-founder of ESAT Camp",
  },
  anson: {
    id: "anson-chan",
    name: "Anson Chan",
    ...
    imageAlt:
      "Temporary portrait placeholder for Anson Chan, co-founder and product lead at ESAT Camp",
  },
} as const;
