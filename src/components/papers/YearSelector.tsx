        ...
        return (
          <button
            ...
            className={cn(
              ...
              "interaction-scale",
              isSelected || isCompleted ? "bg-primary" : "bg-white/5 hover:bg-white/10"
            )}
          >
            <div className="flex items-center gap-2">
              <span className="font-medium text-neutral-100">{year}</span>
              {isCompleted && (
                <div className="w-4 h-4 rounded-full flex items-center justify-center bg-primary text-background">
                  {/* Thick rounded check */}
