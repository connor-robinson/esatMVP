                ...
                <div className="space-y-2">
                  ...
                  <div
                    className={cn(
                      ...
                      partsInGroup.length >= 5
                        ? "lg:grid-cols-5"
                        : partsInGroup.length === 4
                          ? "lg:grid-cols-4"
                          : partsInGroup.length === 3
                            ? "lg:grid-cols-3"
                            : null,
                    )}
                  >
                    {partsInGroup.map((s) => {
                      ...
                      const fiveUp = partsInGroup.length >= 5;
                      return (
                        <div
                          key={s.key}
                          role="button"
                          ...
                          className={cn(
                            "rounded-organic-lg py-3 transition-all duration-fast outline-none",
                            fiveUp ? "px-3" : "px-4",
