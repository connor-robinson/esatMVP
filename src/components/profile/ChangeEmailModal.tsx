      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-3">
            <Mail className="w-5 h-5 text-white/70" strokeWidth={2.5} />
            <h2 className="text-lg font-mono text-white/90 font-semibold">Change Email</h2>
          </div>
          <button
            onClick={onClose}
            disabled={isChanging}
          ...
          <div className="space-y-4 font-mono text-sm">
            <div>
              ...
              <input
                ...
                value={currentEmail}
                disabled
                className="w-full px-4 py-3 rounded-organic-md bg-white/5 border border-white/10 text-white/50 font-mono text-sm cursor-not-allowed"
              />
            </div>
