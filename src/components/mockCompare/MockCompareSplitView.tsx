      ...
      className={cn(
        ...
        accent
          ? marketing
            ...
            : "bg-maths text-neutral-900"
          : marketing
            ? "bg-[#0A0F1D] text-neutral-100"
  ...
  return (
    ...
    >
      ...
      {!results ? (
        <div
          className={cn(
            "rounded-md px-4 py-10 text-center text-sm",
            marketing
              ? "bg-[#0A0F1D] text-[#94A3B8]"
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            {(
              ...
              <div
                key={label}
                className={cn(
                  "rounded-md px-3 py-3 text-center",
                  marketing ? "bg-[#0A0F1D]" : "bg-surface-elevated",
                )}
              >
                <div
                  className={cn(
      ...
      {!isLoggedIn ? (
        <div
          className={cn(
            ...
            marketing ? "bg-[#161D2F]" : "bg-surface-elevated",
          )}
        >
          <div
            className={cn(
