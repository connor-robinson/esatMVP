...
const navSections: NavSectionConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/questions/questionbank/mistakes',
        label: 'Mistakes',
        description: 'Drill questions you got wrong',
        icon: ClipboardList,
        badge: 'PRO',
...
function resolveSection(pathname: string): NavSectionId | 'home' | 'dashboard' {
  if (pathname === DEFAULT_POST_AUTH_PATH || pathname.startsWith(`${DEFAULT_POST_AUTH_PATH}/`)) {
    return 'dashboard';
  }
