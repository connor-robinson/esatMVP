                ...
                {showDrillPopover ? (
                  <button
                    ...
                    className={cn(
                      ...
                      "dark:bg-surface-neutral/80 dark:text-white dark:hover:bg-surface-mid",
                      drillListOpen &&
                        "bg-surface-neutral dark:bg-surface-mid",
                  ...
                  <div
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-organic-md bg-surface-mid text-text dark:bg-surface-neutral/80 dark:text-white"
                    aria-hidden
                  >
                    <ListOrdered className="h-5 w-5" strokeWidth={2} />
                  </div>
