...
/** ESAT Mathematics 1 practice pack, module 2 (Cursor bundle) */
export const MATHS1_MOCK_03_QUESTIONS: EsatCampMockQuestion[] = [
  ...
  {
    number: 2,
    stem: "Water flows at \\(7200\\text{ cm}^{3}\\) per minute. What is this rate in litres per second?",
    options: {
      A: "0.002 L/s",
      B: "0.012 L/s",
      C: "0.072 L/s",
    ...
    targetSeconds: 50,
    targetDisplay: "50 s",
    tip: "Remember that \\(1000\\text{ cm}^{3}\\) equals 1 litre.",
    solution: "\\(7200\\text{ cm}^{3} = 7.2\\) litres. Dividing by 60 gives 0.12 L/s.",
    distractors: {
      A: "Divides by both 60 and 60 again.",
      B: "Converts \\(7200\\text{ cm}^{3}\\) to 0.72 litres before dividing.",
  ...
  {
    number: 4,
    stem: "What is \\(\\dfrac{(6 \\times 10^{7})(4 \\times 10^{-3})}{8 \\times 10^{2}}\\) in standard form?",
    options: {
      A: "\\(3 \\times 10^{-2}\\)",
      B: "\\(3 \\times 10^{-1}\\)",
      C: "3",
    ...
    solution: "The number part is \\(6 \\times \\frac{4}{8} = 3\\). The power is \\(10^{7 - 3 - 2} = 10^{2}\\). Therefore the result is \\(3 \\times 10^{2}\\).",
    distractors: {
  ...
  {
    number: 7,
    stem: "A map has scale 1:25 000. A lake has area \\(6\\text{ cm}^{2}\\) on the map. What is its actual area in hectares?",
    options: {
      A: "0.0375 ha",
      B: "0.375 ha",
      C: "3.75 ha",
    ...
    solution: "One map centimetre represents 250 m, so \\(1\\text{ cm}^{2}\\) represents \\(250^{2} = 62500\\text{ m}^{2}\\). Thus \\(6\\text{ cm}^{2}\\) represents \\(375000\\text{ m}^{2} = 37.5\\) hectares.",
    distractors: {
      ...
      D: "Uses \\(2500\\text{ m}^{2}\\) for each map square centimetre.",
      E: "Uses the map denominator as the answer in hectares.",
      G: "Treats \\(1000\\text{ m}^{2}\\) as one hectare.",
    },
  ...
  },
  {
    ...
    distractors: {
      ...
      E: "Uses 176 × 1.2 instead of reversing the 12% decrease.",
    },
  ...
  },
  {
    ...
    solution: "Write \\(t = \\dfrac{kd}{v^{2}}\\). From \\(6 = 8k/4\\), \\(k = 3\\). Therefore \\(t = 3 \\times \\frac{15}{25} = \\frac{45}{25} = 1.8\\).",
    distractors: {
  ...
  {
    number: 11,
    stem: "For x ≠ -1 and x ≠ 1, which expression is equal to 1/(x - 1) - 1/(x + 1)?",
    options: {
      A: "0",
      B: "2/(x + 1)",
      C: "2/(x - 1)",
    ...
    solution: "Using the common denominator (x - 1)(x + 1), the numerator is (x + 1) - (x - 1) = 2. Hence the result is \\(\\dfrac{2}{x^{2}-1}\\).",
    distractors: {
  ...
  {
    number: 12,
    stem: "A line passes through \\((2, 5)\\) and is perpendicular to \\(y = \\dfrac{1}{2}x - 3\\). What is the y-intercept of the line?",
    options: {
      A: "-9",
      B: "-1",
      C: "9",
  ...
  {
    number: 14,
    stem: "The formula \\(E = \\dfrac{mv^{2}}{2}\\) is used with \\(m = 3\\) and \\(v = 4\\). What is \\(E\\)?",
    options: {
      A: "6",
      B: "8",
      C: "12",
    ...
    solution: "\\(E = 3 \\times 4^{2} / 2 = 3 \\times \\frac{16}{2} = 24\\).",
    distractors: {
  ...
  },
  {
    ...
    editorPick: false,
    diagramKey: "m1-3-q17",
    diagramAlt: "Kite ABCD split by diagonal AC, with AB equal to AD and CB equal to CD.",
  ...
  },
  {
    ...
    distractors: {
      ...
      C: "Uses 360/30 after confusing 24° with a nearby standard angle.",
  ...
  },
  {
    ...
    editorPick: false,
    diagramKey: "m1-3-q20",
    diagramAlt: "Running track formed from a rectangle and two semicircular ends, total length 14 m and radius 3 m.",
    diagramNotToScale: true,
  },
  {
    number: 21,
  ...
  },
  {
    ...
    editorPick: false,
    diagramKey: "m1-3-q22",
    diagramAlt: "Right square-based pyramid with base side 12 cm, centre O, vertical height TO of 6 cm and sloping edge TC.",
    diagramNotToScale: true,
  },
  {
    number: 23,
  ...
  },
  {
    ...
    solution: "The product is odd only if both scores are odd. That probability is \\(\\frac{3}{6}\\times\\frac{3}{6}\\) = \\(\\frac{1}{4}\\). Therefore the probability of an even product is 1 - \\(\\frac{1}{4}\\) = \\(\\frac{3}{4}\\).",
    distractors: {
  ...
  },
  {
    ...
    distractors: {
      ...
      C: "Adds the two known angles instead of subtracting from 180°.",
      D: "Subtracts 42° and 59° from 180° after double-counting 17°.",
      E: "Assumes the other two angles are both 42°.",
      G: "Subtracts only 42° from 180°.",
    },
    benchmarkNote: "ENGAA 2018, Part A, Q21: alternate-segment and circle-angle reasoning.",
    editorPick: true,
    diagramKey: "m1-3-q27",
    diagramAlt: "Circle through A, B and C with a tangent at A; tangent-chord angle 42 degrees and angle BAC 17 degrees.",
    diagramNotToScale: true,
  },
];
