...
export const MATHS1_MOCK_03_QUESTIONS: EsatCampMockQuestion[] = [
  ...
  {
    number: 2,
    stem: "Water flows at 7200 cm³ per minute. What is this rate in litres per second?",
    options: {
      A: "0.002 L/s",
      B: "0.012 L/s",
      C: "0.072 L/s",
    ...
    distractors: {
      ...
      B: "Converts 7200 cm³ to 0.72 litres before dividing.",
  ...
  },
  {
    ...
    distractors: {
      ...
      F: "Treats √5 as 3 during simplification.",
    },
  ...
  {
    number: 4,
    stem: "What is (6 × 10^7)(4 × 10^(-3))/(8 × \\(10^{2}\\)) in standard form?",
    options: {
      A: "3 × 10^(-2)",
      B: "3 × 10^(-1)",
      C: "3",
  ...
  },
  {
    ...
    distractors: {
      ...
      C: "Uses 2³ for the remaining positions.",
      E: "Uses 4² without enforcing that all digits are used once.",
  ...
  {
    number: 7,
    stem: "A map has scale 1:25 000. A lake has area 6 cm² on the map. What is its actual area in hectares?",
    options: {
      A: "0.0375 ha",
      B: "0.375 ha",
      C: "3.75 ha",
    ...
    distractors: {
      ...
      D: "Uses 2500 m² for each map square centimetre.",
      E: "Uses the map denominator as the answer in hectares.",
      G: "Treats 1000 m² as one hectare.",
    },
  ...
  },
  {
    ...
    distractors: {
      A: "Uses v rather than v² and then inverts the final ratio.",
      B: "Uses inverse proportion to v rather than v².",
      C: "Uses k = 2.5 from an incorrect rearrangement.",
      E: "Divides by v rather than v² after finding k.",
      F: "Uses direct proportion to v².",
  ...
  {
    number: 12,
    stem: "A line passes through (2, 5) and is perpendicular to y = \\(\\frac{1}{2}\\) x - 3. What is the y-intercept of the line?",
    options: {
      A: "-9",
      B: "-1",
      C: "9",
  ...
  {
    number: 14,
    stem: "The formula E = mv²/2 is used with m = 3 and v = 4. What is E?",
    options: {
      A: "6",
      B: "8",
      C: "12",
    ...
    distractors: {
      ...
      B: "Calculates v²/2 and omits m.",
      C: "Squares v, subtracts m, then halves approximately.",
      D: "Reports v² only.",
      E: "Calculates mv² but forgets to divide by 2.",
    },
  ...
  {
    number: 16,
    stem: "What are the coordinates of the minimum point of y = (x - 2)² - 3?",
    options: {
      A: "(-2, -3)",
      B: "(2, 3)",
      C: "(-2, 3)",
