...
/** ESAT Mathematics 2 practice pack, module 1 (Cursor bundle) */
export const MATHS2_MOCK_01_QUESTIONS: EsatCampMockQuestion[] = [
  {
    ...
    benchmarkNote: "ENGAA 2022 Section 1, Q1, rational-index simplification style.",
    editorPick: false,
  },
  {
    number: 2,
    ...
    benchmarkNote: "NSAA 2018 Section 1, Q77, tangent line to a quadratic; ENGAA 2021 Section 1, Q11, line-quadratic intersections.",
    editorPick: false,
  },
  {
    number: 3,
  ...
  },
  {
    ...
    distractors: {
      ...
      C: "Uses roots -k ± 1 instead of k ± 1.",
    ...
    benchmarkNote: "ENGAA 2022 Section 1, Q31, complete-set inequality style; NSAA 2019 Section 1, Q89, polynomial sign intervals.",
    editorPick: false,
  },
  {
    number: 6,
  ...
  },
  {
    ...
    benchmarkNote: "ENGAA 2023 Section 1, Q23, linked arithmetic sums; NSAA 2018 Section 1, Q79, conditions on an arithmetic progression.",
    editorPick: false,
  },
  {
    number: 8,
  ...
  },
  {
    ...
    benchmarkNote: "ENGAA 2018 Section 1, Q5, parallel-gradient reasoning; ENGAA 2022 Section 1, Q37, point-to-line geometry.",
    editorPick: false,
  },
  {
    number: 10,
    ...
    editorPick: false,
    diagramKey: "m2-1-q10",
    diagramAlt: "Coordinate diagram of a circle centred at C(2,-1), an external point P(8,-1), and tangent PT.",
  ...
  },
  {
    ...
    benchmarkNote: "Official 2026 Notes on Mathematics, MM3.2 circle-equation examples; broader coordinate-geometry style in ENGAA 2022 Q37.",
    editorPick: false,
  },
  {
    number: 12,
    ...
    solution: "sin 30° = cos 60° = 1/2 and tan 45° = 1. The value is (1/2 + 1/2)/1 = 1.",
    distractors: {
  ...
  },
  {
    ...
    editorPick: false,
    diagramKey: "m2-1-q13",
    diagramAlt: "Circle sector with central angle two pi over three and the minor segment shaded.",
    diagramNotToScale: true,
  },
  {
    number: 14,
    ...
    benchmarkNote: "NSAA 2018 Section 1, Q75, counting trigonometric solutions in a radian interval.",
    editorPick: true,
  },
  {
    number: 15,
    stem: "An acute angle θ satisfies tan θ = 3/4.\n\nWhat is sin θ - cos θ?",
    options: {
      A: "\\(-1\\)",
      B: "\\(-4/5\\)",
      C: "\\(-1/5\\)",
    ...
    solution: "Use a 3-4-5 triangle. Then sin θ = 3/5 and cos θ = 4/5, so sin θ - cos θ = -1/5.",
    distractors: {
    ...
    benchmarkNote: "NSAA 2019 Section 1, Q77, reducing a trigonometric condition to algebraic ratios.",
    editorPick: false,
  },
  {
    number: 16,
  ...
  {
    number: 17,
    stem: "Evaluate\n\nlog₂(3/2) + log₂(4/3) + log₂(5/4) + ... + log₂(32/31).",
    options: {
      A: "\\(-4\\)",
      B: "\\(-1\\)",
      C: "\\(1\\)",
    ...
    solution: "Combine the logarithms. The product telescopes to (3/2)(4/3)...(32/31) = 32/2 = 16. Therefore the sum is log₂16 = 4.",
    distractors: {
  ...
  },
  {
    ...
    editorPick: false,
    diagramKey: "m2-1-q19",
    diagramAlt: "Graph of y equals x cubed minus 3x with tangent and normal at (2,2).",
    diagramNotToScale: true,
  },
  {
    number: 20,
  ...
  {
    number: 21,
    stem: "An open box is made from a 12 by 8 rectangular sheet by cutting a square of side x from each corner and folding up the sides.\n\nFor 0 < x < 4, which value of x gives the maximum volume?",
    options: {
      A: "\\((10 + 2\\sqrt{7})/3\\)",
      B: "\\((10 - \\sqrt{7})/3\\)",
      C: "\\((8 - 2\\sqrt{7})/3\\)",
    ...
    benchmarkNote: "ENGAA 2022 Section 1, Q23, forming an area model from a diagram; official 2026 Notes MM6.3 optimisation style.",
    editorPick: true,
    diagramKey: "m2-1-q21",
    diagramAlt: "Twelve by eight rectangular sheet with four corner squares of side x marked for removal.",
    diagramNotToScale: true,
  },
  {
    number: 22,
    ...
    benchmarkNote: "ENGAA 2018 Section 1, Q29, area enclosed by a curve and a line; official MM7.1 signed-area distinction.",
    editorPick: false,
    diagramKey: "m2-1-q22",
    diagramAlt: "Graph of y equals x minus 1 from x equals zero to three with both regions to the x-axis shaded.",
    diagramNotToScale: true,
  },
  {
    number: 23,
    ...
    benchmarkNote: "Official 2026 Notes on Mathematics, MM7.5 trapezium-rule and overestimate style; no close archive item was used.",
    editorPick: false,
    diagramKey: "m2-1-q23",
    diagramAlt: "Graph of y equals x squared with two trapezia on intervals zero to one and one to two.",
    diagramNotToScale: true,
  },
  {
    number: 24,
    ...
    benchmarkNote: "Official 2026 Notes on Mathematics, MM7.6 first-order differential-equation examples.",
    editorPick: false,
  },
  {
    number: 25,
    ...
    solution: "Replacing x by x + 1 shifts the graph left by 1, so the x-coordinate becomes -3. The y-value transforms as -2(3) + 5 = -1. The turning point is (-3, -1).",
    distractors: {
    ...
    benchmarkNote: "Official Pearson ESAT Mathematics 2 specimen and 2026 Notes MM8.2 graph-transformation style.",
    editorPick: false,
    diagramKey: "m2-1-q25",
    diagramAlt: "Downward parabola with roots (-4,0) and (0,0) and maximum (-2,3).",
    diagramNotToScale: true,
  },
  {
    number: 26,
    ...
    benchmarkNote: "NSAA 2018 Section 1, Q77, tangency as a repeated algebraic solution; ENGAA 2021 Section 1, Q11, intersections encoded by a quadratic.",
    editorPick: true,
    diagramKey: "m2-1-q26",
    diagramAlt: "Graph of y equals x cubed minus 3x and horizontal line y equals 2, tangent at x equals -1 and crossing at x equals 2.",
    diagramNotToScale: true,
  },
  {
    number: 27,
    ...
    benchmarkNote: "Official 2026 Notes on Mathematics, MM5.1 and MM8.1-2 exponential-graph style; official Pearson specimen graph interpretation.",
    editorPick: false,
    diagramKey: "m2-1-q27",
    diagramAlt: "Decreasing exponential through (0,-1) with horizontal asymptote y equals -3.",
    diagramNotToScale: true,
  },
];
