/**
 * OLD VERSION - Drill builder page (from GitHub)
 * 
 * TO RESTORE OLD VERSION:
 * 1. Rename this file to page.tsx
 * 2. Rename the current page.tsx to page.new.tsx
 * 
 * This is the last successful layout from GitHub before the three-column redesign.
 */
...
const TopicSelector = lazy(() =>
  import("@/components/builder/TopicSelector").then((mod) => ({
    default: mod.TopicSelector,
  })),
);
const SessionFolder = lazy(() =>
  import("@/components/builder/SessionFolder").then((mod) => ({
    default: mod.SessionFolder,
  })),
);
const TopicsOverview = lazy(() =>
  import("@/components/builder/TopicsOverview").then((mod) => ({
    default: mod.TopicsOverview,
  })),
);
