...
def caption(ax, x, y):
    ax.text(x, y, "[diagram not to scale]", ha="center", va="top", fontsize=8.5, color=MID)
...
def q01():
    fig, ax = canvas((-1.8, 13.8), (-1.6, 13.5))
    ...
    ax.text(6, y - 0.15, "12 cm", ha="center", va="top")
    caption(ax, 6, -1.45)
    save(fig, "q01-midpoint-incircle.png")


def q05():
    fig, ax = canvas((-0.35, 1.4), (-0.32, 1.28), figsize=(6.1, 5.2))
    ...
    ax.text(0.16, -0.18, "1 : 2", ha="center", va="center", fontsize=9)
    ax.text(1.18, 0.12, "1 : 3", ha="center", va="center", rotation=90, fontsize=9)
    ax.text(0.75, 1.17, "1 : 1", ha="center", va="center", fontsize=9)
    ax.text(-0.18, 0.5, "1", rotation=90, ha="center", va="center")
    caption(ax, 0.5, -0.27)
...
def q07():
    ...
    for n, (x, y) in positions.items():
        weight = "bold" if n in {1, 9, 25} else "normal"
        ax.text(x, y, str(n), ha="center", va="center", fontsize=12, fontweight=weight)
    ax.add_patch(Rectangle((-2.45, -2.45), 4.9, 4.9, fill=False, ec=LIGHT, lw=0.8))
    ax.text(3.0, 0, "…", ha="center", va="center", fontsize=18, color=MID)
    ax.text(0, 2.85, "pattern continues", ha="center", va="center", fontsize=9, color=MID)
    caption(ax, 0, -2.72)
...
def q09():
    ...
    for label, pt, offset in [
        ...
        ax.text(pt[0] + offset[0], pt[1] + offset[1], label, ha="center", va="center")
    ...
    ax.text(0.79, 0.18, "70°", fontsize=10)
...
def q10():
    ...
    ax.text(2.0, 2.5, "18", ha="center", va="center", fontsize=12)
    ax.text(5.6, 2.5, "30", ha="center", va="center", fontsize=12)
    ax.text(2.0, 0.75, "18 teeth", ha="center", va="top")
    ax.text(5.6, -0.05, "30 teeth", ha="center", va="top")
    arrow = FancyArrowPatch(
        (1.1, 3.55), (2.85, 3.65), connectionstyle="arc3,rad=-0.45", arrowstyle="-|>",
        mutation_scale=12, color=MID, lw=1.2
    )
    ax.add_patch(arrow)
    ax.text(1.9, 4.65, "25 revolutions in 12 s", ha="center", va="center", fontsize=10)
    caption(ax, 4.2, -0.52)
...
def q11():
    ...
    ax.text(2.15, 3.55, "Bag A", ha="center", va="center")
    ax.text(8.05, 3.55, "Bag B", ha="center", va="center")
    ...
    ax.text(5.1, 2.62, "one counter", ha="center", va="bottom", fontsize=9)
    ax.text(5.1, 0.0, "R = red      B = blue", ha="center", va="center", fontsize=9, color=MID)
    caption(ax, 5.1, -0.45)
...
def q12():
    ...
    for centre in centres:
        ...
        ax.text(centre[0] + 0.1, centre[1] + 0.85, "r", ha="left", va="center", fontsize=10)
    ...
    ax.text(2.5, 4.45, "square", ha="center", va="center")
    ax.text(7.5, 4.45, "regular hexagon", ha="center", va="center")
    caption(ax, 5.0, -0.35)
...
def q15():
    ...
    for x, r in zip(xs, radii):
        ...
        if r == 1:
            ax.text(x, 2.35, "1 cm", ha="center", va="bottom", fontsize=9.5)
        else:
            ax.text(x + 0.35, r / 2, f"{r} cm", ha="left", va="center", fontsize=9.5)
